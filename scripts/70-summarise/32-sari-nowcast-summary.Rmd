---
title: "SARI: Visualize nowcasting results per reference date"
prerequisites:
...
```{r}
sari_summary <- mutate(sari, cases_baseline = notifications) |>
    reporcases_periods(names(sari_mcmc))
sari_summary
...
p <- plot_nowcast(sari_nowcast, sari_summary, model_labels = model_labels, model_colors = NULL)
p
