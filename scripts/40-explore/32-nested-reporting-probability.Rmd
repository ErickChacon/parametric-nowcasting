...
p <- ggplot(df) +
    geom_line(aes(delay, q1, color = "Exponential: b = 1")) +
    geom_line(aes(delay, q2, color = "Exponential: b = 0.4")) +
    geom_line(aes(delay, q3, color = "Nested function"), linetype = 2, linewidth = 0.7) +
    geom_line(aes(delay, q4, color = "Shifted nested function"), linetype = 4, linewidth = 0.7) +
